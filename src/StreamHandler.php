...
class StreamHandler extends AbstractProcessingHandler
{
    ...
    public function setCustomClosure($closure = null)
    {
    ...
    protected function write(LogRecord $record): void
    {
        if (!is_resource($this->stream)) {
            ...
            if ($this->customClosure !== null && is_callable($this->customClosure)) {
                call_user_func($this->customClosure);
            }
